...
//     const dropdown = button.querySelector(".dropdown-filter");
//     if (!dropdown) return;
...
//       const dropdown = btn.querySelector(".dropdown-filter");
...
function documentActions(e) {
  ...
  if (targetElement.classList.contains('dropdown-btn')) {
    if (targetElement.closest('.dropdown-item').classList.contains('active')) {
      targetElement.closest('.dropdown-item').classList.remove('active');
    } else {
      _removeClasses(document.querySelectorAll('.dropdown-item.active'), 'active');
      targetElement.closest('.dropdown-item').classList.add('active');
    }
  } else if (!targetElement.closest('.dropdown-item') && document.querySelectorAll('.dropdown-item.active').length > 0) {
    _removeClasses(document.querySelectorAll('.dropdown-item.active'), "active");
  }
}
